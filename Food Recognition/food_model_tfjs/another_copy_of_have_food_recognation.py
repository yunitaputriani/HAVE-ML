# -*- coding: utf-8 -*-
"""Another copy of HAVE food recognation

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1QVulKBbYoy5tmSMIw03CY7GXqdbIWWRt
...
uploadfile = '/content/LIST MAKANAN-20240611T161928Z-001.zip'
...
# Assuming `train_generator.class_indices` contains the class indices
...
subprocess.run([
    ...
    "--quantization_bytes=1",  # Menambahkan pengaturan untuk mengoptimalkan model
    "./foods_model.h5",
    "./tfjs_model"
])
